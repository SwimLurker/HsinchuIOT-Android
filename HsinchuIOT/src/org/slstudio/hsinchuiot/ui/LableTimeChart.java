...
public class LableTimeChart extends TimeChart {

	private String[] unitLable;
	
	
	public LableTimeChart(XYMultipleSeriesDataset dataset,
	        ...
	        if (or == Orientation.HORIZONTAL) {
	          if (showLabels && !textLabel) {
	            ...
	            if (axisAlign == Align.LEFT) {
	              ...
	              drawText(canvas, getLabelWithUnit(mRenderer.getLabelFormat(), label, i),
	...
	protected String getLabelWithUnit(NumberFormat format, double label, int scale) {
	    String text = "";
	    if (format != null) {
