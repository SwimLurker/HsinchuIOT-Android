...
public class MenuView extends View{
	...
	public final static int MENU_SORT_BY_STATUS = 0;
	
	public final static int MENU_SORT_BY_CO2 = 1;
	
	public final static int MENU_SORT_BY_TEMPERATURE = 2;
	
	public final static int MENU_SORT_BY_HUMIDITY = 3;
	
	public final static int MENU_SORT_BY_LOCATION = 4;
     ...
     * 横屏菜单最小左边距
     */
    private int minLeftWidth_h = 571;
	...
	public MenuView(Context context){
		...
		popView = layoutInflater.inflate(R.layout.menu_sort, null);
		listView = (ListView)popView.findViewById(R.id.menu_sort_lv);
		layout = (RelativeLayout)popView.findViewById(R.id.menu_sort_layout);
		...
		if(mItems!= null && mItems.size()>0){
			...
			for(int i=0; i< mItems.size(); i++){
				if(paint.measureText(mItems.get(i).MenuValue) > maxWidth){
					maxWidth = paint.measureText(mItems.get(i).MenuValue) / 2;
				}
			}
		}
	}
